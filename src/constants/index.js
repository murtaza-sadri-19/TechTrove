...
const leadership = [
  ...
  },
  {
    ...
    tag: "Leadership",
    points: [
      "Led Team Nakshatra in the ISRO Robotics Challenge, coordinating development and strategy for the competition.",
    ],
  },
  {
    title: "GATE 2026 AIR 1765",
  ...
  },
  {
    ...
    organization: "Top 300 Rank Nationwide",
    date: "Oct 2025",
    icon: sgsits,
    iconBg: "#E6DEDD",
    tag: "Achievement",
    points: [
      "Ranked among the Top 300 nationwide in the Amazon Machine Learning Challenge 2025.",
    ],
  },
  {
    title: "ICEA TruthTell 2025",
    organization: "Top 25 Nationally — Ministry of IT & ICEA",
    date: "Jan 2025",
    icon: sgsits,
    iconBg: "#E6DEDD",
    tag: "Achievement",
...
const projects = [
  {
    name: "Compu-Rf: TLC Spot Detection Engine",
    description:
      "Engineered an automated computer vision pipeline for Thin Layer Chromatography (TLC) Rf value measurement and spot detection using YOLO, OpenCV, and native ONNX Runtime backend integration. Achieved 95% spot detection accuracy in live deployment, eliminating manual chemical analysis for lab technicians.",
    tags: [
      { name: "python", color: "blue-text-gradient" },
      { name: "opencv", color: "green-text-gradient" },
      { name: "yolo", color: "orange-text-gradient" },
      { name: "onnx-runtime", color: "pink-text-gradient" },
    ],
    image: compurf_home,
  ...
  },
  {
    ...
    deploymentStatus: "Deployed",
    deploymentLink: "http://14.139.250.86",
  },
  {
